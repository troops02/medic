      ...
      <SafeAreaView style={styles.areaView}>
         <View style ={styles.container}>
            ...
            <View style={styles.header}>
                    ...
                    <TouchableOpacity style={styles.orderPill} onPress={() => navigation.navigate('CustomerProfile')}>
                        <Image source={{uri:'https://images.pexels.com/photos/3683074/pexels-photo-3683074.jpeg'}}
                        ...
                        <View style={styles.orderDetails}>
                            ...
                            <View style={styles.ordersHolder}>
                                <Text style={styles.customerInfotext}>Adeleke Julian at Apo District, Abuja</Text>
                            </View>
                        </View>
                    </TouchableOpacity>
                    <View style={styles.orderPill}>
                        <Image source={{uri:'https://images.pexels.com/photos/3683074/pexels-photo-3683074.jpeg'}} style={styles.orderThumbnail}/>
                        <View style={styles.orderDetails}>
                            <Text style={styles.ordertext}>Multivitamin for Hair Growth</Text>
                            <View style={styles.ordersHolder}>
                                <Text style={styles.orderInfotext}>N23,000</Text>
